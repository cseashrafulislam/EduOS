...
namespace EduOS.App.Extensions
{
    ...
    {
        public static IServiceCollection AddApplicationServices(this IServiceCollection s, IConfiguration c)
        {
            ...
            s.Configure<MfaSettings>(c.GetSection(MfaSettings.SectionName)); s.AddAutoMapper(_ => { }, typeof(MappingProfile).Assembly);
            ...
            s.AddHttpClient<IAamarPayClient, AamarPayClient>(x => x.Timeout = TimeSpan.FromSeconds(30));
            ...
            s.AddScoped<IAdmissionIntakeService, AdmissionIntakeService>();
            ...
            s.AddScoped<IAcademicSetupService, AcademicSetupService>();
            s.AddScoped<IAcademicRoutineService, AcademicRoutineService>();
            s.AddScoped<IAcademicEnrollmentService, AcademicEnrollmentService>();
