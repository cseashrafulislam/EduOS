...
public sealed class HrPayrollController:ControllerBase
{
 ...
 [HttpPost("attendance")][Authorize(Roles="TenantAdmin,Principal,HR")][RequireModule("HR")]
 ...
 [HttpPost("generate")][Authorize(Roles="TenantAdmin,Principal,HR,Accountant")][RequireModule("PAYROLL")]
