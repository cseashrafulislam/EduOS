...
public sealed class LmsWorkflowController:ControllerBase
{
    ...
    [HttpPut("lessons")][Authorize(Roles="TenantAdmin,Principal,Teacher")][EnableRateLimiting("ApiPolicy")]
    ...
    [HttpPut("assignments")][Authorize(Roles="TenantAdmin,Principal,Teacher")][EnableRateLimiting("ApiPolicy")]
    ...
    [HttpPost("courses/{reference:guid}/sync-enrollment")][Authorize(Roles="TenantAdmin,Principal,Teacher")][EnableRateLimiting("ApiPolicy")]
    ...
    [HttpPost("assignments/review")][Authorize(Roles="TenantAdmin,Principal,Teacher")][EnableRateLimiting("ApiPolicy")]
    ...
    [HttpPost("lessons/complete")][Authorize(Roles="Student")][EnableRateLimiting("ApiPolicy")]
