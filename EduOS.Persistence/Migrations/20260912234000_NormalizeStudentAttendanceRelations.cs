...
[Migration("20260912234000_NormalizeStudentAttendanceRelations")]
public partial class NormalizeStudentAttendanceRelations : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        NormalizeRelation(migrationBuilder, "StudentAttendances", "ClassId", "ClassId1", "Classes");
        NormalizeRelation(migrationBuilder, "StudentAttendances", "SectionId", "SectionId1", "Sections");
    }
    ...
    private static void NormalizeRelation(MigrationBuilder migrationBuilder, string table, string column, string shadowColumn, string parentTable)
    {
