...
[Migration("20260913071500_NormalizeExamAccessRelations")]
public partial class NormalizeExamAccessRelations : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        NormalizeRequiredRelation(migrationBuilder, "SeatPlans", "ExamScheduleId", "ExamSchedules");
        NormalizeRequiredRelation(migrationBuilder, "SeatPlans", "StudentId", "Students");
        NormalizeRequiredRelation(migrationBuilder, "SeatPlans", "HallId", "ExamHalls");
        NormalizeRequiredRelation(migrationBuilder, "AdmitCards", "ExamId", "Exams");
        NormalizeRequiredRelation(migrationBuilder, "AdmitCards", "StudentId", "Students");
    }
