...
[Migration("20260912235000_NormalizeNoticeRelations")]
public partial class NormalizeNoticeRelations : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        NormalizeOptionalRelation(migrationBuilder, "Notices", "CategoryId", "CategoryId1", "NoticeCategories");
        NormalizeOptionalRelation(migrationBuilder, "Notices", "ClassId", "ClassId1", "Classes");
    }
    ...
    private static void NormalizeOptionalRelation(MigrationBuilder migrationBuilder, string table, string column, string shadowColumn, string parentTable)
    {
