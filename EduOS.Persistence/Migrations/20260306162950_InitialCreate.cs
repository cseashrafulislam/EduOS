        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountCreated = table.Column<bool>(type: "bit", nullable: false),
                    EmailVerified = table.Column<bool>(type: "bit", nullable: false),
                    InstitutionProfileCompleted = table.Column<bool>(type: "bit", nullable: false),
                    CampusSetupCompleted = table.Column<bool>(type: "bit", nullable: false),
                    AcademicSetupCompleted = table.Column<bool>(type: "bit", nullable: false),
                    AdminUserSetupCompleted = table.Column<bool>(type: "bit", nullable: false),
                    RolePermissionSetupCompleted = table.Column<bool>(type: "bit", nullable: false),
                    SubscriptionSetupCompleted = table.Column<bool>(type: "bit", nullable: false),
                    FinalCompleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerActiveStudentAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MinStudentLimit = table.Column<int>(type: "int", nullable: true),
                    MaxStudentLimit = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveStudentCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RolePagePermissions_AppPages_AppPageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPagePermissions_AppPages_AppPageId",
                        column: x => x.AppPageId,
                        principalTable: "AppPages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveStudentCount = table.Column<int>(type: "int", nullable: false),
                    FixedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PerStudentAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    StudentChargeAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingInvoices_InvoiceNo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePagePermissions_AppPageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePagePermissions_RoleId_AppPageId_PermissionId",
                table: "RolePagePermissions",
                columns: new[] { "RoleId", "AppPageId", "PermissionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPagePermissions_AppPageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPagePermissions_UserId_AppPageId_PermissionId",
                table: "UserPagePermissions",
                columns: new[] { "UserId", "AppPageId", "PermissionId" },
                unique: true);
        }
