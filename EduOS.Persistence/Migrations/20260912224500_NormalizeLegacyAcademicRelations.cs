...
[Migration("20260912224500_NormalizeLegacyAcademicRelations")]
public partial class NormalizeLegacyAcademicRelations : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        NormalizeRequiredRelation(migrationBuilder, "Holidays", "AcademicYearId", "AcademicYearId1", "AcademicYears");
        NormalizeRequiredRelation(migrationBuilder, "LessonPlans", "ClassId", "ClassId1", "Classes");
        NormalizeRequiredRelation(migrationBuilder, "LessonPlans", "SubjectId", "SubjectId1", "Subjects");
        NormalizeRequiredRelation(migrationBuilder, "LessonPlans", "TeacherId", "TeacherId1", "Employee");
    }
    ...
    private static void NormalizeRequiredRelation(MigrationBuilder migrationBuilder, string table, string column, string shadowColumn, string parentTable)
    {
...
BEGIN
    ...
    BEGIN
        ...
        EXEC(N'UPDATE [dbo].[{table}] SET [{column}Normalized]=CASE WHEN [{shadowColumn}] IS NOT NULL AND [{column}]=0 THEN CONVERT(bigint,[{shadowColumn}]) ELSE CONVERT(bigint,[{column}]) END;');
